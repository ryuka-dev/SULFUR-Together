...
> **Version 1.1.0 — Public Beta: SULFUR 0.18.3 support, shared loot, and fixes.** It works, but it is still being polished. Expect bugs, back up your saves, and make sure everyone runs the same version.
